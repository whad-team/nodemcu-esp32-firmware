...
#ifndef PB_BLE_PROTOCOL_BLE_PB_H_INCLUDED
#define PB_BLE_PROTOCOL_BLE_PB_H_INCLUDED
#include "nanopb/pb.h"
...
typedef struct _ble_DeviceDiscovered { 
    pb_callback_t bd_address;
    pb_callback_t adv_data;
    pb_callback_t scanrsp_data;
} ble_DeviceDiscovered;
...
#define ble_SniffAdvCmd_init_default             {0, false, 0}
...
#define ble_DeviceDiscovered_init_default        {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define ble_DeviceDiscovered_init_zero           {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define ble_PduReceived_init_zero                {0, {{NULL}, NULL}, 0}
...
#define ble_DeviceDiscovered_bd_address_tag      1
#define ble_DeviceDiscovered_adv_data_tag        2
#define ble_DeviceDiscovered_scanrsp_data_tag    3
...
#define ble_PduReceived_access_address_tag       1
#define ble_PduReceived_pdu_tag                  2
#define ble_PduReceived_crc_tag                  3
...
#define ble_Message_device_disc_tag              21
...
#define ble_Message_pdu_received_tag             26
...
#define ble_DeviceDiscovered_FIELDLIST(X, a) \
X(a, CALLBACK, SINGULAR, BYTES,    bd_address,        1) \
X(a, CALLBACK, SINGULAR, BYTES,    adv_data,          2) \
X(a, CALLBACK, SINGULAR, BYTES,    scanrsp_data,      3)
#define ble_DeviceDiscovered_CALLBACK pb_default_field_callback
#define ble_DeviceDiscovered_DEFAULT NULL
...
X(a, STATIC,   ONEOF,    MESSAGE,  (msg,device_disc,msg.device_disc),  21) \
...
X(a, STATIC,   ONEOF,    MESSAGE,  (msg,pdu_received,msg.pdu_received),  26)
...
#define ble_Message_msg_device_disc_MSGTYPE ble_DeviceDiscovered
...
#define ble_Message_msg_pdu_received_MSGTYPE ble_PduReceived
...
extern const pb_msgdesc_t ble_DeviceDiscovered_msg;
...
#define ble_DeviceDiscovered_fields &ble_DeviceDiscovered_msg
...
/* ble_DeviceDiscovered_size depends on runtime parameters */
